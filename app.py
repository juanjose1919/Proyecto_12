...
st.subheader('Aquí se observan 10 variables obtenidas del Banco Mundial cuyo proposito es de expicar la felicidad de un país, cuya muestra es de 60 países alrededor del mundo')
